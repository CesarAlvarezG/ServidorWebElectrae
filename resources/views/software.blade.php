         ...
         <div class="software_section_2 layout_padding">
             ...
             <div>
                  ...
                  {{-- <div class="col-sm-4">
                     ...
                     <input type="text" name="hsp" id="inputHSP" class="form-control">
                  ...
                  <div class="col-sm-4">
                     ...
                     <input type="datetime-local" name="fecha_medicion" id="inputFechaMedicion" class="form-control">


                  </div>
                  <div class="col-sm-12 text-end my-2">
                     <button type="submit" class="bton btn-primary">
                        Guardar
                     </button>
                  </div> --}}
